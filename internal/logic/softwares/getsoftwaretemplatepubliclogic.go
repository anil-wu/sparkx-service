...
type GetSoftwareTemplatePublicLogic struct {
	logx.Logger
	ctx    context.Context
	svcCtx *svc.ServiceContext
}

func NewGetSoftwareTemplatePublicLogic(ctx context.Context, svcCtx *svc.ServiceContext) *GetSoftwareTemplatePublicLogic {
	return &GetSoftwareTemplatePublicLogic{
...
func (l *GetSoftwareTemplatePublicLogic) GetSoftwareTemplatePublic(req *types.GetSoftwareTemplateReq) (resp *types.SoftwareTemplateResp, err error) {
	if req.Id <= 0 {
